...
func (_ERC721 *ERC721Transactor) Initialize(opts *bind.TransactOpts, name string, symbol string) (*types.Transaction, error) {
	return _ERC721.contract.Transact(opts, "initialize", name, symbol)
}

// Initialize is a paid mutator transaction binding the contract method 0x4cd88b76.
//
// Solidity: function initialize(string name, string symbol) returns()
func (_ERC721 *ERC721Session) Initialize(name string, symbol string) (*types.Transaction, error) {
	return _ERC721.Contract.Initialize(&_ERC721.TransactOpts, name, symbol)
}

// Initialize is a paid mutator transaction binding the contract method 0x4cd88b76.
//
// Solidity: function initialize(string name, string symbol) returns()
func (_ERC721 *ERC721TransactorSession) Initialize(name string, symbol string) (*types.Transaction, error) {
	return _ERC721.Contract.Initialize(&_ERC721.TransactOpts, name, symbol)
}
...
//
// Solidity: function setBaseURI(string buri) returns()
func (_ERC721 *ERC721Transactor) SetBaseURI(opts *bind.TransactOpts, buri string) (*types.Transaction, error) {
	return _ERC721.contract.Transact(opts, "setBaseURI", buri)
}

// SetBaseURI is a paid mutator transaction binding the contract method 0x55f804b3.
//
// Solidity: function setBaseURI(string buri) returns()
func (_ERC721 *ERC721Session) SetBaseURI(buri string) (*types.Transaction, error) {
	return _ERC721.Contract.SetBaseURI(&_ERC721.TransactOpts, buri)
}

// SetBaseURI is a paid mutator transaction binding the contract method 0x55f804b3.
//
// Solidity: function setBaseURI(string buri) returns()
func (_ERC721 *ERC721TransactorSession) SetBaseURI(buri string) (*types.Transaction, error) {
	return _ERC721.Contract.SetBaseURI(&_ERC721.TransactOpts, buri)
}

// SetcontractURI is a paid mutator transaction binding the contract method 0xefa00ce7.
//
// Solidity: function setcontractURI(string curi) returns()
func (_ERC721 *ERC721Transactor) SetcontractURI(opts *bind.TransactOpts, curi string) (*types.Transaction, error) {
	return _ERC721.contract.Transact(opts, "setcontractURI", curi)
}

// SetcontractURI is a paid mutator transaction binding the contract method 0xefa00ce7.
//
// Solidity: function setcontractURI(string curi) returns()
func (_ERC721 *ERC721Session) SetcontractURI(curi string) (*types.Transaction, error) {
	return _ERC721.Contract.SetcontractURI(&_ERC721.TransactOpts, curi)
}

// SetcontractURI is a paid mutator transaction binding the contract method 0xefa00ce7.
//
// Solidity: function setcontractURI(string curi) returns()
func (_ERC721 *ERC721TransactorSession) SetcontractURI(curi string) (*types.Transaction, error) {
	return _ERC721.Contract.SetcontractURI(&_ERC721.TransactOpts, curi)
}
